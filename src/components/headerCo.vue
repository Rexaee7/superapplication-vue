...
<div v-if="showCategory" >
    <div class="category-content">
      <div class="items">
          <span :class="{'active' : category=='mobile'}" @click="activeCategory('mobile')">
          ...
          <span :class="{'active' : category=='tablet'}" @click="activeCategory('tablet')">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-phone" viewBox="0 0 16 16">
              <path d="M11 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1zM5 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z"/>
              <path d="M8 14a1 1 0 1 0 0-2 1 1 0 0 0 0 2"/>
            </svg>
          ...
          <span :class="{'active' : category=='laptop'}" @click="activeCategory('laptop')">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-phone" viewBox="0 0 16 16">
              <path d="M11 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1zM5 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z"/>
              <path d="M8 14a1 1 0 1 0 0-2 1 1 0 0 0 0 2"/>
            </svg>
          ...
          <span :class="{'active' : category=='headphone'}" @click="activeCategory('headphone')">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-phone" viewBox="0 0 16 16">
              <path d="M11 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1zM5 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z"/>
              <path d="M8 14a1 1 0 1 0 0-2 1 1 0 0 0 0 2"/>
            </svg>
      ...
      <div v-show="category == 'mobile'" class="filters">
        <div class="filter">
          <h4>برندها</h4>
          <div class="filter__item">
            <span class="filter__child">
              <span>
                سامسونگ
              </span>
              <span>
        ...
        <div class="filter">
          ...
          <div class="filter__item">
            <span class="filter__child">
              <span>
                تا  <span v-farsi-number="5"></span>  میلیون تومان
              </span>
              <span>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-left" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M11.354 1.646a.5.5 0 0 1 0 .708L5.707 8l5.647 5.646a.5.5 0 0 1-.708.708l-6-6a.5.5 0 0 1 0-.708l6-6a.5.5 0 0 1 .708 0"/>
            ...
            <span class="filter__child">
              <span>
                تا  <span v-farsi-number="10"></span>  میلیون تومان
              </span>
              <span>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-left" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M11.354 1.646a.5.5 0 0 1 0 .708L5.707 8l5.647 5.646a.5.5 0 0 1-.708.708l-6-6a.5.5 0 0 1 0-.708l6-6a.5.5 0 0 1 .708 0"/>
            ...
            <span class="filter__child">
              <span>
                تا  <span v-farsi-number="15"></span>  میلیون تومان
              </span>
              <span>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-left" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M11.354 1.646a.5.5 0 0 1 0 .708L5.707 8l5.647 5.646a.5.5 0 0 1-.708.708l-6-6a.5.5 0 0 1 0-.708l6-6a.5.5 0 0 1 .708 0"/>
  ...
  <header class="nav" >
    <div class="nav__body">
      ...
      <div class="nav__title">
        <router-link to="/" class="nav__header">فروشگاه</router-link>
      </div>
      <!--left side (cart icon)-->
      <div class="nav__cart">
          ...
          <span class="categories__item">
            ...
            <router-link to="/#magic">
              <span class="categories__item">
                  ...
                  <span class="nav-link " href="#">شگفت‌انگیزها </span>
              </span>
            </router-link>
            <router-link to="">
              <span class="categories__item">
            ...
            <router-link to="">
              <span class="categories__item">
                  ...
                  <span class="nav-link " href="#">پر فروش‌ها</span>
              </span>
            </router-link>
            <router-link to="">
              <span class="categories__item">
                  ...
                  <span class="nav-link " href="#">جدیدترین‌ها</span>
              </span>
            </router-link>
          </span>
          </span>
...
<div class="mobileNav">
  <router-link exact-active-class="active" to="/" @click="tabChange('home')" :class="{'active': tabActive=='home'}" class="tab">
    ...
    <span>
      <svg v-show="tabActive == 'home'" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-house-fill" viewBox="0 0 16 16">
        <path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L8 2.207l6.646 6.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293z"/>
        <path d="m8 3.293 6 6V13.5a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 13.5V9.293z"/>
      </svg>
      <svg v-show="tabActive != 'home'" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-house" viewBox="0 0 16 16">
  ...
  <router-link exact-active-class="active" :to="{path:'/category',query:{cat:'mobile'}}" @click="tabChange('category')" :class="{'active': tabActive=='category'}" class="tab">
    ...
    <span>
        <svg v-show="tabActive == 'category'" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
              <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
        </svg>
      <svg v-show="tabActive != 'category'" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
            <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
  ...
  <router-link exact-active-class="active" to="/cart" @click="tabChange('cart')" :class="{'active': tabActive=='cart'}" class="tab">
    ...
    <span id="cart__span">
      <svg v-show="tabActive == 'cart'" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-basket-fill" viewBox="0 0 16 16">
        <path d="M5.071 1.243a.5.5 0 0 1 .858.514L3.383 6h9.234L10.07 1.757a.5.5 0 1 1 .858-.514L13.783 6H15.5a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-.5.5H15v5a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V9H.5a.5.5 0 0 1-.5-.5v-2A.5.5 0 0 1 .5 6h1.717zM3.5 10.5a.5.5 0 1 0-1 0v3a.5.5 0 0 0 1 0zm2.5 0a.5.5 0 1 0-1 0v3a.5.5 0 0 0 1 0zm2.5 0a.5.5 0 1 0-1 0v3a.5.5 0 0 0 1 0zm2.5 0a.5.5 0 1 0-1 0v3a.5.5 0 0 0 1 0zm2.5 0a.5.5 0 1 0-1 0v3a.5.5 0 0 0 1 0z"/>
      </svg>
      <svg v-show="tabActive != 'cart'" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-basket" viewBox="0 0 16 16">
  ...
  <router-link exact-active-class="active" to="/blog" @click="tabChange('blog')" :class="{'active': tabActive=='blog'}" class="tab">
    ...
    <span>
      <svg v-show="tabActive == 'blog'" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-postcard-heart-fill" viewBox="0 0 16 16">
      ...
      <svg v-show="tabActive != 'blog'" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-postcard-heart" viewBox="0 0 16 16">
  ...
  <router-link exact-active-class="active" to="/login" @click="tabChange('login')" :class="{'active': tabActive=='profile'}" class="tab">

    <span>
      <svg v-show="tabActive == 'login'" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
        <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6"/>
      </svg>
      <svg v-show="tabActive != 'login'" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
        <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0m4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4m-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10s-3.516.68-4.168 1.332c-.678.678-.83 1.418-.832 1.664z"/>
      </svg>
    </span>
    <span>
